...
var MAP_LEFT_BG = Color.decode("#1F7A3A"), MAP_RIGHT_BG = Color.decode("#F5F5F5");
var MAP_LINE_BLUE = Color.decode("#1F7A3A"), MAP_STATION_BLACK = Color.decode("#1A1A1A");
var MAP_UP_ONLY_RED = Color.decode("#D0021B"), MAP_DN_ONLY_GREEN = Color.decode("#1E5BA8");
var MAP_LEFT_WHITE = Color.decode("#FFFFFF");
var MAP_DOT_BLUE = Color.decode("#1F7A3A"), MAP_DOT_UP = Color.decode("#D0021B"), MAP_DOT_DN = Color.decode("#1E5BA8");

/* 左面板配置 */
var MAP_OPERATOR_NAME = (typeof COMPANY_NAME !== "undefined" && COMPANY_NAME && COMPANY_NAME.length > 0)
    ? String(COMPANY_NAME) : "浦东巴士";
var MAP_COMPANY_PHONE = (typeof COMPANY_PHONE !== "undefined" && COMPANY_PHONE && COMPANY_PHONE.length > 0)
