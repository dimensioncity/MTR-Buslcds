...
var MAP_LEFT_BG = Color.decode("#1E5BA8"), MAP_RIGHT_BG = Color.decode("#F5F5F5");
var MAP_LINE_BLUE = Color.decode("#1E5BA8"), MAP_STATION_BLACK = Color.decode("#1A1A1A");
var MAP_UP_ONLY_RED = Color.decode("#D0021B"), MAP_DN_ONLY_GREEN = Color.decode("#009933");
var MAP_LEFT_WHITE = Color.decode("#FFFFFF");
var MAP_DOT_BLUE = Color.decode("#1E5BA8"), MAP_DOT_UP = Color.decode("#D0021B"), MAP_DOT_DN = Color.decode("#009933");

/* 左面板配置 */
var MAP_OPERATOR_NAME = (typeof COMPANY_NAME !== "undefined" && COMPANY_NAME && COMPANY_NAME.length > 0)
    ? String(COMPANY_NAME) : "奉贤巴士";
